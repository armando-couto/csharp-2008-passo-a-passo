...
namespace DLINQOrders
{
    class DLINQReport
    {
        ...
        {
            Northwind northwindDB = new Northwind("Integrated Security=true;Initial Catalog=Northwind;Data Source=.\\SQLExpress");
                ...
                foreach (var order in ordersQuery)
                {
                    ...
                    else
                    {
                        Console.WriteLine(
                            ...
                            order.ShippedDate, order.ShipName, order.ShipAddress, order.ShipCity,
                            order.ShipCountry);
                    }
                }
            }
